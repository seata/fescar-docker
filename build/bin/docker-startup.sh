...
CLASSPATH=$CLASSPATH_PREFIX:"$BASEDIR"/conf:"$REPO"/fescar-core-0.1.0-SNAPSHOT.jar:"$REPO"/fastjson-1.2.48.jar:"$REPO"/netty-all-4.1.24.Final.jar:"$REPO"/fescar-config-0.1.0-SNAPSHOT.jar:"$REPO"/config-1.2.1.jar:"$REPO"/slf4j-api-1.7.22.jar:"$REPO"/logback-classic-1.1.6.jar:"$REPO"/logback-core-1.1.6.jar:"$REPO"/junit-4.12.jar:"$REPO"/hamcrest-core-1.3.jar:"$REPO"/fescar-common-0.1.0-SNAPSHOT.jar:"$REPO"/commons-pool2-2.4.2.jar:"$REPO"/commons-pool-1.6.jar:"$REPO"/commons-lang-2.6.jar:"$REPO"/fescar-server-0.1.0-SNAPSHOT.jar
EXTRA_JVM_ARGUMENTS="-XX:MaxDirectMemorySize=1024M"
